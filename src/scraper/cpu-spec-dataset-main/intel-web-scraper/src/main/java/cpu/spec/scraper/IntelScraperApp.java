...
public class IntelScraperApp {
    ...
    private static final String HOST_URL = "https://www.intel.com";

    public static void main(String[] args) throws ElementNotFoundException, IOException, DirectoryNotFoundException, InterruptedException {
    ...
    private static List<String> extractSpecificationLinks(List<String> seriesLinks) throws InterruptedException {
        ...
        for (String link : seriesLinks) {
            ...
            TimeUnit.MILLISECONDS.sleep((long) (Math.random() * 3000) + 500);
        }
        return specificationLinks;
    }

    private static List<CpuSpecificationModel> extractSpecifications(List<String> specificationLinks) throws InterruptedException {
