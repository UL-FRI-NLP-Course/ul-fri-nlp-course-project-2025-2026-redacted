...
public abstract class GpuMegaPageParser {
    private static final String ENTRY_URL = "https://www.videocardbenchmark.net/GPU_mega_page.html";

    /**
     * @return gpu links for sub routing (url decoded = clean texts)
    ...
    public static List<String> extractSpecificationLinks() throws Exception {
        ...
        try {
            ...
            for (WebElement row : tableRows) {
                ...
                href = href.replaceAll("gpu_lookup.php", "gpu.php");
                href = href.replaceAll("video_lookup.php", "gpu.php");
