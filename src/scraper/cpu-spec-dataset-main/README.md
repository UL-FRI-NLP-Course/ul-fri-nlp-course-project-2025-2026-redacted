...
* [GPU Benchmark Web Scraper](gpu-benchmark-web-scraper/src/main/java/cpu/spec/scraper)
...
### [GPU Benchmark Dataset](dataset/benchmark-gpus.csv)

Extracted from [https://www.videocardbenchmark.net/GPU_mega_page.html](https://www.videocardbenchmark.net/GPU_mega_page.html)
with the responsible __Web Scraper__.

```shell
cd gpu-benchmark-web-scraper
java -jar ./target/executable.jar
```
